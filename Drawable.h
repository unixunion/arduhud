...
// button
// class DrawableButton : Drawable
// {
// 	void new(TVout& tv, unsigned int x, unsigned int y, unsigned int w, unsigned int h, char* title) 
// 	{
...
// // hbar
// class DrawableHBar : Drawable 
// {
// 	void new(TVout& tv, int x, int y, int length)
// 	{
